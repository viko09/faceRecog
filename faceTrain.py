...
# Load dataset
df = pd.read_csv('/Users/vikoluna/Apps/PyCharm/faceRecog/dataSet/list_attr_celeba.csv', sep=',', header=None)

df = df[1:]

# Replacing not useful values
...
data = tf.data.Dataset.zip(
    (files, attributes))
path_to_images = '/Users/vikoluna/Apps/PyCharm/faceRecog/dataSet/img_align_celeba/img_align_celeba/'
...
inputs = tf.keras.Input(shape=(192, 192, 3), name='input')
